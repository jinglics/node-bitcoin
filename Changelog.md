...
* remove commands dropped in litecoind v0.11
  * `getHashesPerSecond`
  * `getHashesPerSec`
* add missing commands for litecoind v0.11
  * `generate`
  * `verifyTxOutProof`

## v2.4.0 (2015/07/16)
* don't lazy-load http/https modules
* add command for litecoind v0.11.0: `getTxOutProof`
...
## v2.3.1 (2015/06/24)
* add missing `getMempoolInfo` for litecoind v0.10

## v2.3.0 (2015/02/04)
* drop node v0.8.x support
* update testnet-box
* update devDependencies
* add commands for litecoind v0.10
  * `estimateFee`
  * `estimatePriority`
  * `getChainTips`
  * `importAddress`
...
## v2.2.0 (2014/08/29)
* add commands for litecoind v0.9.x
  * `decodeScript`
  * `dumpWallet`
  * `getBestBlockHash`
  * `getBlockchainInfo`
...
* remove deprecated functionality
  * creating `litecoin.Client` with more than one argument

## v1.7.0 (2013/05/05)
* add missing commands from litecoind v0.7.0
  * `createMultiSig`
  * `getBlockTemplate`
  * `getTxOut`
  * `getTxOutSetInfo`
...
* upgrade testnet-box
* add commands for litecoind v0.8.0
  * `addNode`
  * `getAddedNodeInfo`
  * `listLockUnspent`
  * `lockUnspent`
* deprecate creating `litecoin.Client` with more than one argument
* add SSL support
...
## v1.4.0 (2012/09/09)
* add commands for litecoind v0.7.0
...
## v1.1.6 (2012/04/11)
* add commands for litecoind v0.6.0
